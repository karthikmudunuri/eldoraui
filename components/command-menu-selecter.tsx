...
export function CodeBlockCommand({
  ...
  return (
    <div className="relative mt-6 max-h-[650px] overflow-x-auto rounded-xl bg-zinc-950 dark:bg-black">
      <Tabs
      ...
      >
        <div className="flex items-center justify-between border-b border-zinc-800 bg-zinc-950 px-3 pt-2.5">
