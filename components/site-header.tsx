...
import { NumberTicker } from "@/registry/default/eldoraui/number-ticker";
    ...
    >
      <div className="container flex h-16 items-center">
        ...
        <Link
          ...
          >
            <span className="absolute right-0 -mt-12 h-32 w-8 translate-x-12 rotate-12 bg-white px-3 opacity-10 transition-all duration-1000 ease-out group-hover:-translate-x-40" />
            <div className="flex items-center "> {/* Added a container div */}
              <Icons.gitHub className="h-4 w-4" />
              <span className="ml-1">Star on GitHub</span> {/* Adjusted spacing */}
            </div>
            <div className="ml-2 flex items-center gap-1 text-sm md:flex"> {/* Adjusted alignment */}
