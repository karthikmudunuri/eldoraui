...
export function RippleDemo() {
  return (
    <div className="relative overflow-hidden rounded-lg bg-zinc-900 p-12 flex items-center justify-center">
      <p className="text-zinc-400 text-sm z-10">Click anywhere in this area</p>
      <Ripple />
    </div>
  );
}
  ...
  return (
    <div className="grid grid-cols-3 gap-8 text-center">
      <div>
        ...
        <p className="text-sm text-zinc-500 mt-2">Active Users</p>
      </div>
      <div>
        <div className="text-5xl font-bold">
        ...
        <p className="text-sm text-zinc-500 mt-2">Uptime</p>
      </div>
      <div>
        <div className="text-5xl font-bold">
          $<NumberTicker value={1.2} decimalPlaces={1} />M
        </div>
        <p className="text-sm text-zinc-500 mt-2">Revenue Processed</p>
      </div>
    </div>
  );
}
...
export function UpgradePrompt() {
  return (
    <div className="bg-gradient-to-b from-zinc-900 to-zinc-950 rounded-2xl p-8 text-center">
      <h3 className="text-xl font-bold text-white mb-2">
        Unlock Pro Features
      </h3>
      <p className="text-zinc-400 text-sm mb-6">
        Get access to advanced analytics, priority support,
