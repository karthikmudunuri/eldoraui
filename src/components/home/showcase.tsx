...
import Wyze from '../../../public/wyze.png';
import HackClub from '../../../public/hackclub.jpeg';
import DonaAI from '../../../public/hackclub.jpeg';
import LLMReport from '../../../public/hackclub.jpeg';
import Texts from '../../../public/hackclub.jpeg';
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-8 items-center">
          ...
          >
            <span className="relative text-base font-semibold text-purple-600 dark:text-white">
              {translations.showCase.showCase}
            </span>
          </Link>
        </div>
      </Container>
